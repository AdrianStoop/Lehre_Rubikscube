...
// Non-ASCII spezielle scancode's 
#define    KESC         1
#define    KF1          0x80
#define    KF2         (KF1 + 1)
#define    KF3         (KF2 + 1)
...
// "Meta" Tasten
#define    KMETA_ALT     0x0200                                // Alt ist gedrückt
#define    KMETA_CTRL    0x0400                                // Ctrl ist gedrückt
#define    KMETA_SHIFT   0x0800                                // Shift ist gedrückt
#define    KMETA_ANY    (KMETA_ALT | KMETA_CTRL | KMETA_SHIFT)
#define    KMETA_CAPS    0x1000                                // CapsLock ist an
#define    KMETA_NUM     0x2000                                // NumLock ist an
#define    KMETA_SCRL    0x4000                                // ScrollLock is an

// andere Tasten
#define    KPRNT    ( KRIGHT + 1 )
